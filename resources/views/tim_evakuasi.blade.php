...
<title>Formulir Penilaian Tim Evakuasi</title>
...
<div class="top">
  <div class="top-inner wrap" style="padding:0;">
    ...
    <h1>Formulir Penilaian Tim Evakuasi</h1>
    <p>Penilaian kinerja Tim Evakuasi dalam mengarahkan, menyisir area, dan memastikan keselamatan penghuni menuju titik kumpul.</p>
  </div>
</div>
...
<div class="wrap">
  ...
  <div class="meta card-shell">
    ...
    <div class="field">
      ...
      <input type="text" id="lokasi" placeholder="Mis. Tangga Darurat Lantai 3">
    </div>
    <div class="field">
  ...
  <div class="section-head">
    <h2>Penilaian Tim Evakuasi</h2>
    <span id="filledCount">0/5 diisi</span>
  </div>
  ...
  <div class="summary card-shell">
    ...
    <div class="total-row">
      <div class="total-left">
        <div class="n"><span id="totalNilai">0</span> / 20</div>
  ...
  <footer>Formulir Penilaian Tim Evakuasi &mdash; Sudin Penanggulangan Kebakaran dan Penyelamatan Kota Administrasi Jakarta Utara</footer>
</div>

<div class="progress-bar">
  <span class="progress-label" id="progressLabel">0%</span>
  <div class="progress-track"><div class="progress-fill" id="progressFill"></div></div>
  <span class="progress-label" id="progressScore">0/20</span>
</div>

<script>
(function(){
  const INDICATORS = [
    { title: "Pemahaman Jalur Evakuasi", desc: "Mengetahui dengan jelas semua jalur evakuasi" },
    { title: "Efektivitas Bimbingan", desc: "Memberikan arahan yang jelas dan tegas kepada penghuni" },
    { title: "Penyisiran Area", desc: "Memastikan tidak ada penghuni yang tertinggal di area tanggung jawabnya" },
    { title: "Penanganan Penghuni Panik/Bingung", desc: "Mampu menenangkan dan mengarahkan penghuni yang panik" },
    { title: "Ketegasan dalam Mengarahkan", desc: "Mampu membuat penghuni mengikuti instruksi" }
  ];
  const SCALE = [
  ...
  function render(){
    ...
    els.filled.textContent = `${answered}/5 diisi`;
    ...
    els.pScore.textContent = total + '/20';
  ...
  document.getElementById('btnPdf').addEventListener('click', function(){
    ...
    if (emptyIdx !== -1){
      ...
      alert(`Poin nomor ${emptyIdx + 1} ("${INDICATORS[emptyIdx].title}") belum dinilai. Semua 5 indikator wajib diisi (kolom Keterangan boleh dikosongkan).`);
      return;
    }
    ...
    try{
      ...
      doc.text('Penilaian Tim Evakuasi', pageW/2, y, { align:'center' });
      y += 3;
      ...
      doc.setFontSize(8.5);
      doc.setTextColor(34,28,26);
      doc.text(`Total Nilai: ${lastTotal} / 20   |   Rata-rata: ${lastRata.toFixed(1)}   |   Predikat: ${lastPredikatText}`, marginX, afterTableY);
      ...
      const fileParts = ['hasil-penilaian-tim-evakuasi'];
