...
<title>Formulir Penilaian Tim Pengamanan</title>
...
<div class="top">
  <div class="top-inner wrap" style="padding:0;">
    ...
    <h1>Formulir Penilaian Tim Pengamanan</h1>
    <p>Penilaian kinerja Tim Pengamanan dalam mengisolasi area dan melayani komunikasi serta bantuan eksternal.</p>
  </div>
</div>
...
<div class="wrap">
  ...
  <div class="meta card-shell">
    ...
    <div class="field">
      ...
      <input type="text" id="lokasi" placeholder="Mis. Gerbang Utama">
    </div>
    <div class="field">
  ...
  <div class="section-head">
    <h2>Penilaian Tim Pengamanan</h2>
  ...
  <footer>Formulir Penilaian Tim Pengamanan &mdash; Sudin Penanggulangan Kebakaran dan Penyelamatan Kota Administrasi Jakarta Utara</footer>
</div>
...
(function(){
  const INDICATORS = [
    { title: "Pemahaman Terkait Jenis Kejadian Kedaruratan", desc: "Mengetahui lokasi dan kondisi yang berkembang saat ini" },
    { title: "Keterampilan Komunikasi dan Melayani Penghuni atau Pengunjung", desc: "Mampu melakukan komunikasi dan memberikan jawaban dan Solusi bagi penghuni dan pengunjung" },
    { title: "Pengamanan Area", desc: "Memastikan area bahaya diisolasi" },
    { title: "Koordinasi dengan Tim Bantuan Eksternal", desc: "Memberikan informasi yang relevan dan membantu akses bantuan dari luar" }
  ];
  const SCALE = [
  ...
  document.getElementById('btnPdf').addEventListener('click', function(){
    ...
    try{
      ...
      doc.text('Penilaian Tim Pengamanan', pageW/2, y, { align:'center' });
      y += 3;
      ...
      const fileParts = ['hasil-penilaian-tim-pengamanan'];
