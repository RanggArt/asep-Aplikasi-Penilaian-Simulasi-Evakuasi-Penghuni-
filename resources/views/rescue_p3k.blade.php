...
<title>Formulir Penilaian Tim Rescue dan P3K</title>
...
<div class="top">
  <div class="top-inner wrap" style="padding:0;">
    ...
    <h1>Formulir Penilaian Tim Rescue dan P3K</h1>
    <p>Penilaian kinerja Tim Rescue dan P3K dalam memberikan respon dan pertolongan darurat pada saat simulasi evakuasi.</p>
  </div>
</div>
...
<div class="wrap">
  ...
  <div class="meta card-shell">
    ...
    <div class="field">
      ...
      <input type="text" id="lokasi" placeholder="Mis. Posko Medis Darurat">
    </div>
    <div class="field">
  ...
  <div class="section-head">
    <h2>Penilaian Tim Rescue dan P3K</h2>
  ...
  <footer>Formulir Penilaian Tim Rescue dan P3K &mdash; Sudin Penanggulangan Kebakaran dan Penyelamatan Kota Administrasi Jakarta Utara</footer>
</div>
...
(function(){
  const INDICATORS = [
    { title: "Kecepatan Respons", desc: "Cepat mencapai lokasi penghuni yang membutuhkan bantuan" },
    { title: "Ketepatan Penanganan", desc: "Memberikan pertolongan pertama yang sesuai dengan kondisi" },
    { title: "Ketersediaan Peralatan", desc: "Memiliki peralatan P3K yang memadai" },
    { title: "Koordinasi dengan Tim Lain", desc: "Berkoordinasi dengan tim evakuasi untuk penanganan lebih lanjut" }
  ];
  const SCALE = [
  ...
  document.getElementById('btnPdf').addEventListener('click', function(){
    ...
    try{
      ...
      doc.text('Penilaian Tim Rescue dan P3K', pageW/2, y, { align:'center' });
      y += 3;
      ...
      const fileParts = ['hasil-penilaian-tim-rescue'];
