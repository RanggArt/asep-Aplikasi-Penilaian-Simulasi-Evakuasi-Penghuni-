...
<title>Formulir Penilaian Tim Pemadam Kebakaran Internal</title>
...
<div class="top">
  <div class="top-inner wrap" style="padding:0;">
    ...
    <h1>Formulir Penilaian Tim Pemadam Kebakaran Internal</h1>
    <p>Penilaian kinerja Tim Pemadam Internal dalam melakukan pemadaman awal dan koordinasi keamanan lokasi bahaya.</p>
  </div>
</div>
...
<div class="wrap">
  ...
  <div class="meta card-shell">
    ...
    <div class="field">
      ...
      <input type="text" id="lokasi" placeholder="Mis. Area Titik Api">
    </div>
    <div class="field">
  ...
  <div class="section-head">
    <h2>Penilaian Tim Pemadam Internal</h2>
  ...
  <footer>Formulir Penilaian Tim Pemadam Internal &mdash; Sudin Penanggulangan Kebakaran dan Penyelamatan Kota Administrasi Jakarta Utara</footer>
</div>
...
(function(){
  const INDICATORS = [
    { title: "Pemahaman Lokasi APAR/Hydrant", desc: "Mengetahui lokasi dan cara penggunaan alat pemadam kebakaran" },
    { title: "Keterampilan Pemadaman Awal", desc: "Mampu melakukan pemadaman awal dengan benar dan aman" },
    { title: "Pengamanan Area", desc: "Memastikan area bahaya diisolasi" },
    { title: "Koordinasi dengan Pemadam Kebakaran Eksternal", desc: "Memberikan informasi yang relevan dan membantu akses" }
  ];
  const SCALE = [
  ...
  document.getElementById('btnPdf').addEventListener('click', function(){
    ...
    try{
      ...
      doc.text('Penilaian Tim Pemadam Kebakaran Internal', pageW/2, y, { align:'center' });
      y += 3;
      ...
      const fileParts = ['hasil-penilaian-tim-pemadam-internal'];
