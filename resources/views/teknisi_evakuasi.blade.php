...
<title>Formulir Penilaian Tim Teknisi</title>
...
<div class="top">
  <div class="top-inner wrap" style="padding:0;">
    ...
    <h1>Formulir Penilaian Tim Teknisi</h1>
    <p>Penilaian kinerja dan kesigapan Tim Teknisi gedung dalam merespons simulasi evakuasi darurat kebakaran.</p>
  </div>
</div>
...
<div class="wrap">
  ...
  <div class="meta card-shell">
    ...
    <div class="field">
      ...
      <input type="text" id="lokasi" placeholder="Mis. Ruang Kontrol / Panel">
    </div>
    <div class="field">
  ...
  <footer>Formulir Penilaian Tim Teknisi &mdash; Sudin Penanggulangan Kebakaran dan Penyelamatan Kota Administrasi Jakarta Utara</footer>
</div>
...
(function(){
  const INDICATORS = [
    { title: "Kecepatan Aktivasi Alarm", desc: "Mengaktifkan alarm segera setelah mendapatkan informasi" },
    { title: "Kejelasan Pengumuman Evakuasi", desc: "Pesan yang disampaikan melalui pengeras suara mudah dipahami" },
    { title: "Manajemen Komunikasi", desc: "Menjaga jalur komunikasi tetap terbuka dan menyampaikan informasi relevan" },
    { title: "Protokol Pelaporan", desc: "Melaporkan kejadian sesuai prosedur" }
  ];
  const SCALE = [
  ...
  document.getElementById('btnPdf').addEventListener('click', function(){
    ...
    try{
      ...
      doc.text('Penilaian Tim Teknisi', pageW/2, y, { align:'center' });
      y += 3;
      ...
      const fileParts = ['hasil-penilaian-tim-teknisi'];
