...
<title>Formulir Penilaian Tim Penanganan Titik Kumpul</title>
...
<div class="top">
  <div class="top-inner wrap" style="padding:0;">
    ...
    <div class="top-eyebrow">
      <img src="{{ asset('assets/logo_damkar.png') }}" alt="Logo" style="width: 18px; height: 18px; object-fit: contain;">
      Sudin Penanggulangan Kebakaran dan Penyelamatan Kota Administrasi Jakarta Utara
    </div>
    <h1>Formulir Penilaian Tim Penanganan Titik Kumpul</h1>
    <p>Penilaian ketertiban, akurasi pendataan, dan pelaporan penghuni setelah dievakuasi ke titik kumpul aman.</p>
  </div>
</div>
...
<div class="wrap">
  ...
  <div class="meta card-shell">
    ...
    <div class="field">
      ...
      <input type="text" id="lokasi" placeholder="Mis. Lapangan Parkir Depan">
    </div>
    <div class="field">
  ...
  <div class="section-head">
    <h2>Penilaian Tim Penanganan Titik Kumpul</h2>
  ...
  <footer>Formulir Penilaian Tim Penanganan Titik Kumpul &mdash; Sudin Penanggulangan Kebakaran dan Penyelamatan Kota Administrasi Jakarta Utara</footer>
</div>
...
(function(){
  const INDICATORS = [
    { title: "Pengaturan Area Titik Kumpul", desc: "Mampu mengarahkan penghuni untuk berkumpul dengan tertib" },
    { title: "Kecepatan & Akurasi Pendataan", desc: "Melakukan perhitungan/pendataan penghuni dengan cepat dan tepat" },
    { title: "Pelaporan Informasi", desc: "Menyampaikan laporan status titik kumpul kepada Koordinator Lapangan" },
    { title: "Penanganan Penghuni Hilang/Terpisah", desc: "Memiliki prosedur untuk mencatat dan melaporkan jika ada penghuni yang tidak ditemukan" }
  ];
  const SCALE = [
  ...
  document.getElementById('btnPdf').addEventListener('click', function(){
    ...
    if (emptyIdx !== -1){
      ...
      alert(`Poin nomor ${emptyIdx + 1} ("${INDICATORS[emptyIdx].title}") belum dinilai. Semua 4 indikator wajib diisi (kolom Keterangan boleh dikosongkan).`);
      return;
    }
    ...
    try{
      ...
      doc.text('Penilaian Tim Penanganan Titik Kumpul', pageW/2, y, { align:'center' });
      y += 3;
      ...
      const fileParts = ['hasil-penilaian-titik-kumpul'];
